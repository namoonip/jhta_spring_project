    ...
    <div class="row text-right">
      ...
      <div class="row">
		<div style="padding-top: 2px; text-align: center;  border:1px solid gray;">
			<form action="/jhta/prof/profPwdCheck" method="POST">
				...
				<div class="text-left">
					<p>
						<label for="profPwd" style="padding-left: 30px; padding-right: 28px;">현재 비밀번호</label> 
						<input type="password" id="profPwd" name="profPwd"/>	
					</p>
					<p>
				...
				<div style="padding-top: 2px; text-align:                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      center;">
					<p>
						...
						<a href="/jhta/prof/profinfo" class="btn btn-danger">취소</a>
					</p>
				</div>
			</form>
		</div>
