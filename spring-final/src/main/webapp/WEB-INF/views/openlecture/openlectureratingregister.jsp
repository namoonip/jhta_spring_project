                    ...
                    <div class="container">
                        ...
                        <div class="mdl-tabs mdl-js-tabs mdl-js-ripple-effect">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    ...
                                    <button id="modal-button" type="button" class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab" style="color: black" data-toggle="modal" data-target="#myModal">
						<i class="material-icons md-48">search</i>
                                                            ...
                                                            <form action="">
                                                                <div class="mdl-layout__header-row">
                                                                    ...
                                                                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--expandable mdl-textfield--floating-label mdl-textfield--align-right">
                                                                        <label class="mdl-button mdl-js-button mdl-button--icon" for="fixed-header-drawer-exp"> <i
                                                        ...
                                                        <table class="mdl-data-table mdl-js-data-table table table-fixed" style="width: 100%;">
                                                            ...
                                                            <tbody id="professorinformationtbody">
                                                                <c:forEach var="professorList" items="${openlecturelist }">
                                                                    <tr>
                                                                        <td><input type="radio" id="option-${professorList.no }" name="options" value="${professorList.code }-${professorList.subjectNo }-${professorList.name }-${professorList.subjectName }">
                                                                        </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <form>
                                        <button id="add-text" type="button" class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab" style="color: black">
                            ...
                            <div class="row">
                                <form class="form-horizontal" action="investigating.do">
                                    ...
                                    <div class="col-sm-10">
                                        <input id="professorIdHidden" name="professorId" type="hidden" value="" /> <input id="professorSubject" name="subjectNo" type="hidden" value=""> <input id="professorreister" name="register" type="hidden" value="y" />
                                    </div>
                                    <div class="col-sm-2">
