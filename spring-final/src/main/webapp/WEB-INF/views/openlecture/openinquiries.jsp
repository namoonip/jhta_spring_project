...
<style>
.wrap_table {padding:30px 0px; position:relative; width:1140px;}
.wrap_table > div {overflow:auto; height:153px;}
.wrap_table table {width:1140px;}
			...
			$.ajax({
				...
				success: function(data){
					...
					for(i=0; i<data.length; i++){
						...
						var html = "<tr>"
						html += "<td style=width:10%><input type='checkbox'/></td>"
						...
						html += "<td style=width:15%><button value="+subjectNo+" id='openlecture' type='button' class='btn btn-default btn-xs'data-toggle='modal' data-target='.bs-example-modal-lg'><i class='glyphicon glyphicon-list-alt'></i></button></td>";
						html += "</tr>";
					...
					$("#openlecture").on("click", function(){
						
						var SubjectNo = $(this).val();
