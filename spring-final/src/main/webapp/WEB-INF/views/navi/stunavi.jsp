            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color: #4296dc;">            
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="stuMain" style="color: white;"><span class="glyphicon glyphicon-education"></span> JHTA 학사 관리 시스템</a>
                    ...
                    <div id="navbar-collapse" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav navbar-right">
                        	<li><a id="user-profile" href="#"style="color: white;"><img src="" class="img-responsive img-thumbnail img-circle"> ${LOGIN_USER }님 환영합니다.</a></li>
