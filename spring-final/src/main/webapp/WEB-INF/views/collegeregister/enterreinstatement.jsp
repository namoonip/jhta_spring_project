...
<body>
	...
	<div class="container" style="margin-left: 250px; padding-top:25px; ">
		<div class="row text-right">
			홈 > 학적관리 > 복학관리 > <strong>복학 승인 목록</strong> 
		</div>
		<div class="row" style="margin: 0px; padding: 0px;">
			<h4><span class="glyphicon glyphicon-list-alt"></span> 복학 승인 목록</h4>
							...
							<tbody>
								...
								<c:forEach var="rein" items="${reinList }" varStatus="status">
									<tr>
										...
										<td class="text-center"><a class="btn btn-primary btn-xs" href="reininfoOK?no=${rein.no }">내역 확인</a></td>	
									</tr>
								</c:forEach>
							</tbody>
						</table>
		...
		<form action="enterreinstatementform" method="post" id="search-form">
