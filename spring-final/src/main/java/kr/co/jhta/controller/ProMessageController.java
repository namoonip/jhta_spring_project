...
public class ProMessageController {
	...
	@RequestMapping("/prof/promessageform")
	public String proMessageForm(Model model) {
		model.addAttribute("messageForm", new MessageForm());
		return "message/promessageform";
	}
	
	@RequestMapping("/prof/prosendmessagebox")
	public String proSendEmailBox(Model model, Professor prof, @RequestParam(name="pno", defaultValue="1") int pno) {
		...
		return "message/prosendmessagebox";
	}
	
	@RequestMapping("/prof/prorecmessagebox")
	public String proRecieveEmailBox(Model model, Professor prof, @RequestParam(name="pno", defaultValue="1") int pno) {
		...
		return "message/prorecmessagebox";
	}
	
	@RequestMapping(value="/prof/sendmessage", method=RequestMethod.POST)
	public String sendMessage(@ModelAttribute(name="messageForm") MessageForm messageForm, Professor prof, String option) throws IllegalAccessException, InvocationTargetException, FileNotFoundException, IOException {
		...
		return "redirect:/prof/prorecmessagebox";
	}
	
	@RequestMapping(value="/prof/deletesendmessage")
	public String deleteSendMessage(Integer[] dnoList) {
		for (int dno : dnoList) {
			messageService.deleteSendMessage(dno);
		}
		
		return "redirect:/prof/prosendmessagebox";
	}
	
	@RequestMapping(value="/prof/deletereceivemessage")
	...
	@RequestMapping("/prof/messagedownload")
	...
	@RequestMapping(value="/prof/addmessagecheck", produces="application/json; charset=UTF-8")
